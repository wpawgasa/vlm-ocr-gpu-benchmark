"""Adapter for OlmOCR2 (7B, Qwen2-VL based)."""
...
class OlmOcrAdapter(OCRModelAdapter):
    """Adapter for allenai/olmOCR2-7B-0225-preview."""

    def get_model_id(self) -> str:
        return "allenai/olmOCR2-7B-0225-preview"
